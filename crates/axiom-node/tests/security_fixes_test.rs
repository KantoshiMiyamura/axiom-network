...
// These tests are documentation-style markers asserting that the named
// security fixes remain present in the source. Each test body is a constant
// `assert!(true, "...")` whose message documents the wiring; the assertion
// itself is intentionally trivial.
