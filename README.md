...
**Status:** Public testnet — `v1.0.1-testnet.6` — **not yet mainnet**
**License:** MIT
...
- **Stable (testnet):** the blockchain core — node, RPC, wallet library, CLI, consensus, networking. This is what `v1.0.1-testnet.6` ships and what the release pipeline builds.
